...
req = shared.LinkTokenCreateRequest(
    ...
    account_filters=shared.LinkTokenAccountFilters(
        ...
        depository=shared.DepositoryFilter(
            account_subtypes=[
                shared.DepositoryAccountSubtype.MONEY_MARKET,
            ],
            additional_properties={
                'key': 'string',
            },
        ...
        investment=shared.InvestmentFilter(
            account_subtypes=[
                shared.InvestmentAccountSubtype.OTHER_INSURANCE,
            ],
            additional_properties={
                'key': 'string',
            },
        ...
        loan=shared.LoanFilter(
            account_subtypes=[
                shared.LoanAccountSubtype.OTHER,
            ],
            additional_properties={
                'key': 'string',
            },
    ...
    constraints=shared.PaymentInitiationConsentConstraints(
        ...
        periodic_amounts=[
            shared.PaymentConsentPeriodicAmount(
                alignment=shared.PaymentConsentPeriodicAlignment.CONSENT,
                amount=shared.PaymentAmount(
                    currency=shared.PaymentAmountCurrency.EUR,
                    value=4177.13,
                ),
                interval=shared.PaymentConsentPeriodicInterval.YEAR,
            ),
        ],
