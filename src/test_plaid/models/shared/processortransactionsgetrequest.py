...
class ProcessorTransactionsGetRequest:
    ...
    options: Optional[shared_transactionsgetrequestoptions.TransactionsGetRequestOptions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('options'), 'exclude': lambda f: f is None }})
