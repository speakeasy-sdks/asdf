...
import dataclasses
from ..shared import watchlistscreeninghit as shared_watchlistscreeninghit
...
class WatchlistScreeningIndividualHitListResponse:
    ...
    watchlist_screening_hits: List[shared_watchlistscreeninghit.WatchlistScreeningHit] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('watchlist_screening_hits') }})
