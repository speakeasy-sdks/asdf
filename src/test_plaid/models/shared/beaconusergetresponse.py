...
from ..shared import beaconuserdata as shared_beaconuserdata
from ..shared import beaconuserstatus as shared_beaconuserstatus
...
class BeaconUserGetResponse:
    ...
    status: shared_beaconuserstatus.BeaconUserStatus = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    ...
    user: shared_beaconuserdata.BeaconUserData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('user') }})
