...
from .watchlistscreeningsearchterms import WatchlistScreeningSearchTerms
...
class WatchlistScreeningIndividual:
    ...
    search_terms: WatchlistScreeningSearchTerms = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('search_terms') }})
