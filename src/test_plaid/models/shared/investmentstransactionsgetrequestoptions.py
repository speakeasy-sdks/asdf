...
class InvestmentsTransactionsGetRequestOptions:
    ...
    async_update: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('async_update'), 'exclude': lambda f: f is None }})
