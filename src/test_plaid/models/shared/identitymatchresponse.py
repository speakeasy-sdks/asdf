...
import dataclasses
from ..shared import accountidentitymatchscore as shared_accountidentitymatchscore
...
class IdentityMatchResponse:
    ...
    accounts: List[shared_accountidentitymatchscore.AccountIdentityMatchScore] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('accounts') }})
