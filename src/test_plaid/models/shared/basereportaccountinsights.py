...
import dataclasses
from ..shared import basereportaverageflowinsights as shared_basereportaverageflowinsights
from ..shared import basereportlongestgapinsights as shared_basereportlongestgapinsights
from ..shared import basereportnumberflowinsights as shared_basereportnumberflowinsights
...
class BaseReportAccountInsights:
    ...
    average_inflow_amount: Optional[List[shared_basereportaverageflowinsights.BaseReportAverageFlowInsights]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('average_inflow_amount') }})
    ...
    average_outflow_amount: Optional[List[shared_basereportaverageflowinsights.BaseReportAverageFlowInsights]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('average_outflow_amount') }})
    ...
    longest_gap_between_transactions: Optional[List[shared_basereportlongestgapinsights.BaseReportLongestGapInsights]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('longest_gap_between_transactions'), 'exclude': lambda f: f is None }})
    ...
    number_of_inflows: Optional[List[shared_basereportnumberflowinsights.BaseReportNumberFlowInsights]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('number_of_inflows') }})
    r"""The number of debits into the account. This field will be null for non-depository accounts."""
    number_of_outflows: Optional[List[shared_basereportnumberflowinsights.BaseReportNumberFlowInsights]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('number_of_outflows') }})
