...
from ..shared import verificationofasset as shared_verificationofasset
...
class Service:
    ...
    verification_of_asset: shared_verificationofasset.VerificationOfAsset = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('VERIFICATION_OF_ASSET') }})
