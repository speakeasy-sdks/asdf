...
import dataclasses
from ..shared import watchlistscreeningdocumenttype as shared_watchlistscreeningdocumenttype
...
class WatchlistScreeningDocument:
    ...
    type: shared_watchlistscreeningdocumenttype.WatchlistScreeningDocumentType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
