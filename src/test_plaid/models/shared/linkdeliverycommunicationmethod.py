...
import dataclasses
from ..shared import linkdeliverydeliverymethod as shared_linkdeliverydeliverymethod
...
class LinkDeliveryCommunicationMethod:
    ...
    method: Optional[shared_linkdeliverydeliverymethod.LinkDeliveryDeliveryMethod] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('method'), 'exclude': lambda f: f is None }})
