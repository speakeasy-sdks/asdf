...
import dataclasses
from .entityscreeninghitemails import EntityScreeningHitEmails
...
class EntityScreeningHitEmailsItems:
    ...
    data: Optional[EntityScreeningHitEmails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
