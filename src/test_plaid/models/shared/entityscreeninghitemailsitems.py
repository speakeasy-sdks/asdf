...
import dataclasses
from ..shared import entityscreeninghitemails as shared_entityscreeninghitemails
...
class EntityScreeningHitEmailsItems:
    r"""Analyzed emails for the associated hit"""
    ...
    data: Optional[shared_entityscreeninghitemails.EntityScreeningHitEmails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
