...
import dataclasses
from ..shared import partnerendcustomersecrets as shared_partnerendcustomersecrets
from ..shared import partnerendcustomerstatus as shared_partnerendcustomerstatus
...
class PartnerEndCustomerWithSecrets:
    ...
    secrets: Optional[shared_partnerendcustomersecrets.PartnerEndCustomerSecrets] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('secrets'), 'exclude': lambda f: f is None }})
    r"""The secrets for the newly created end customer in non-Production environments."""
    status: Optional[shared_partnerendcustomerstatus.PartnerEndCustomerStatus] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
