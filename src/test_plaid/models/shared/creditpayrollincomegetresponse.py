...
import dataclasses
from ..shared import payrollitem as shared_payrollitem
...
class CreditPayrollIncomeGetResponse:
    ...
    items: List[shared_payrollitem.PayrollItem] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items') }})
