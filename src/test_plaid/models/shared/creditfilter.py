...
import dataclasses
from ..shared import creditaccountsubtype as shared_creditaccountsubtype
...
class CreditFilter:
    ...
    account_subtypes: List[shared_creditaccountsubtype.CreditAccountSubtype] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('account_subtypes') }})
