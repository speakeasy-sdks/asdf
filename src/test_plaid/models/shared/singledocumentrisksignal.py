...
from .documentrisksummary import DocumentRiskSummary
...
class SingleDocumentRiskSignal:
    ...
    risk_summary: DocumentRiskSummary = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('risk_summary') }})
