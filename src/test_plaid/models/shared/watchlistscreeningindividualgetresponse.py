...
from ..shared import watchlistscreeningsearchterms as shared_watchlistscreeningsearchterms
...
class WatchlistScreeningIndividualGetResponse:
    r"""The screening object allows you to represent a customer in your system, update their profile, and search for them on various watchlists. Note: Rejected customers will not receive new hits, regardless of program configuration."""
    ...
    search_terms: shared_watchlistscreeningsearchterms.WatchlistScreeningSearchTerms = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('search_terms') }})
    r"""Search terms for creating an individual watchlist screening"""
    status: shared_watchlistscreeningstatus.WatchlistScreeningStatus = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
