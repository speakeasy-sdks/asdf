...
class NumbersACHNullable:
    ...
    can_transfer_in: Optional[bool] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('can_transfer_in'), 'exclude': lambda f: f is NumbersACHNullable.UNSET }})
    r"""Whether the account supports ACH transfers into the account"""
    can_transfer_out: Optional[bool] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('can_transfer_out'), 'exclude': lambda f: f is NumbersACHNullable.UNSET }})
