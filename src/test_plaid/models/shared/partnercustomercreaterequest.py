...
class PartnerCustomerCreateRequest:
    ...
    address: dict[str, Any] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address') }})
    ...
    assets_under_management: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assets_under_management'), 'exclude': lambda f: f is None }})
    r"""Assets under management for the given end customer. Required for end customers with monthly service commitments."""
    billing_contact: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('billing_contact'), 'exclude': lambda f: f is None }})
    ...
    customer_support_info: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('customer_support_info'), 'exclude': lambda f: f is None }})
    ...
    technical_contact: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('technical_contact'), 'exclude': lambda f: f is None }})
