...
import dataclasses
from ..shared import removedtransaction as shared_removedtransaction
...
class TransactionsSyncResponse:
    r"""TransactionsSyncResponse defines the response schema for `/transactions/sync`"""
    added: List[shared_transaction.Transaction] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('added') }})
    ...
    modified: List[shared_transaction.Transaction] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('modified') }})
    ...
    removed: List[shared_removedtransaction.RemovedTransaction] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('removed') }})
