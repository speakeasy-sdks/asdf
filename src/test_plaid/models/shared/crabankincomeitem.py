...
from ..shared import crabankincomeaccount as shared_crabankincomeaccount
from ..shared import crabankincomesource as shared_crabankincomesource
...
class CraBankIncomeItem:
    ...
    bank_income_accounts: Optional[List[shared_crabankincomeaccount.CraBankIncomeAccount]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bank_income_accounts'), 'exclude': lambda f: f is None }})
    r"""The Item's accounts that have Bank Income data."""
    bank_income_sources: Optional[List[shared_crabankincomesource.CraBankIncomeSource]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bank_income_sources'), 'exclude': lambda f: f is None }})
