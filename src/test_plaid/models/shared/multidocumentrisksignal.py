...
class MultiDocumentRiskSignal:
    ...
    document_references: List[shared_risksignaldocumentreference.RiskSignalDocumentReference] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('document_references') }})
