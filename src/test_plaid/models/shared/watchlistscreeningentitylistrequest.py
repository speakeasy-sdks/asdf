...
class WatchlistScreeningEntityListRequest:
    r"""Request input for listing entity watchlist screenings"""
    ...
    cursor: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cursor'), 'exclude': lambda f: f is WatchlistScreeningEntityListRequest.UNSET }})
