...
from .institutionsgetbyidrequestoptions import InstitutionsGetByIDRequestOptions
...
class InstitutionsGetByIDRequest:
    ...
    options: Optional[InstitutionsGetByIDRequestOptions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('options'), 'exclude': lambda f: f is None }})
