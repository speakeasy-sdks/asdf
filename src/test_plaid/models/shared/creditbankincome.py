...
from ..shared import creditbankincomeitem as shared_creditbankincomeitem
from ..shared import creditbankincomesummary as shared_creditbankincomesummary
from ..shared import creditbankincomewarning as shared_creditbankincomewarning
...
class CreditBankIncome:
    ...
    bank_income_summary: Optional[shared_creditbankincomesummary.CreditBankIncomeSummary] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bank_income_summary'), 'exclude': lambda f: f is None }})
    ...
    items: Optional[List[shared_creditbankincomeitem.CreditBankIncomeItem]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})
    r"""The list of Items in the report along with the associated metadata about the Item."""
    warnings: Optional[List[shared_creditbankincomewarning.CreditBankIncomeWarning]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('warnings'), 'exclude': lambda f: f is None }})
