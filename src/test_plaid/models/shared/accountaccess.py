...
import dataclasses
from ..shared import accountproductaccessnullable as shared_accountproductaccessnullable
...
class AccountAccess:
    ...
    account_product_access: Optional[shared_accountproductaccessnullable.AccountProductAccessNullable] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('account_product_access') }})
