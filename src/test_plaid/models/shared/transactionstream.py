...
from ..shared import recurringtransactionfrequency as shared_recurringtransactionfrequency
from ..shared import transactionstreamamount as shared_transactionstreamamount
from ..shared import transactionstreamstatus as shared_transactionstreamstatus
...
class TransactionStream:
    ...
    average_amount: shared_transactionstreamamount.TransactionStreamAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('average_amount') }})
    ...
    frequency: shared_recurringtransactionfrequency.RecurringTransactionFrequency = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('frequency') }})
    ...
    last_amount: shared_transactionstreamamount.TransactionStreamAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('last_amount') }})
    r"""Object with data pertaining to an amount on the transaction stream."""
    ...
    status: shared_transactionstreamstatus.TransactionStreamStatus = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
