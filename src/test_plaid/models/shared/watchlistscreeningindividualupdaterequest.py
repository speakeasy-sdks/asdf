...
class WatchlistScreeningIndividualUpdateRequest:
    ...
    reset_fields: Optional[list[shared_watchlistscreeningindividualupdaterequestresettablefield.WatchlistScreeningIndividualUpdateRequestResettableField]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reset_fields'), 'exclude': lambda f: f is None }})
    r"""A list of fields to reset back to null"""
    search_terms: Optional[shared_updateindividualscreeningrequestsearchterms.UpdateIndividualScreeningRequestSearchTerms] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('search_terms'), 'exclude': lambda f: f is None }})
