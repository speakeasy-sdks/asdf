...
import dataclasses
from ..shared import paystubaddress as shared_paystubaddress
from ..shared import taxpayerid as shared_taxpayerid
...
class Employee:
    ...
    address: shared_paystubaddress.PaystubAddress = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address') }})
    ...
    taxpayer_id: Optional[shared_taxpayerid.TaxpayerID] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxpayer_id'), 'exclude': lambda f: f is None }})
