...
import dataclasses
from .watchlistscreeningindividual import WatchlistScreeningIndividual
...
class WatchlistScreeningIndividualHistoryListResponse:
    ...
    watchlist_screenings: List[WatchlistScreeningIndividual] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('watchlist_screenings') }})
