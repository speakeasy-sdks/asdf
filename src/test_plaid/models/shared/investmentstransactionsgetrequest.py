...
class InvestmentsTransactionsGetRequest:
    ...
    options: Optional[shared_investmentstransactionsgetrequestoptions.InvestmentsTransactionsGetRequestOptions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('options'), 'exclude': lambda f: f is None }})
