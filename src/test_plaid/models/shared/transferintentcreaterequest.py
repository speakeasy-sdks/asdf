...
class TransferIntentCreateRequest:
    ...
    """
    network: Optional[shared_transferintentcreatenetwork.TransferIntentCreateNetwork] = dataclasses.field(default=TransferIntentCreateNetwork.SAME_DAY_ACH, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('network'), 'exclude': lambda f: f is None }})
