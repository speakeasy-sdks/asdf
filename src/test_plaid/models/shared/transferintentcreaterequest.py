...
class TransferIntentCreateRequest:
    ...
    """
    network: Optional[shared_transferintentcreatenetwork.TransferIntentCreateNetwork] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('network'), 'exclude': lambda f: f is None }})
    ...
    """
    require_guarantee: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('require_guarantee'), 'exclude': lambda f: f is None }})
