...
class Item:
    ...
    available_products: List[shared_products.Products] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('available_products') }})
    ...
    billed_products: List[shared_products.Products] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('billed_products') }})
    ...
    """
    error: Optional[shared_plaiderror.PlaidError] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
    ...
    update_type: ItemUpdateType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('update_type') }})
    r"""Indicates whether an Item requires user interaction to be updated, which can be the case for Items with some forms of two-factor authentication.
    ...
    consented_products: Optional[List[shared_products.Products]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('consented_products'), 'exclude': lambda f: f is None }})
