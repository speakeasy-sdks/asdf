...
class SandboxTransferSimulateRequest:
    ...
    failure_reason: Optional[TransferFailure] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failure_reason'), 'exclude': lambda f: f is SandboxTransferSimulateRequest.UNSET }})
    ...
    test_clock_id: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('test_clock_id'), 'exclude': lambda f: f is SandboxTransferSimulateRequest.UNSET }})
