...
class PaymentInitiationStandingOrderMetadata:
    ...
    valid_standing_order_intervals: List[shared_paymentscheduleinterval.PaymentScheduleInterval] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('valid_standing_order_intervals') }})
