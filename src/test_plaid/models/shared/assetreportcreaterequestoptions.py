...
class AssetReportCreateRequestOptions:
    ...
    client_report_id: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('client_report_id'), 'exclude': lambda f: f is AssetReportCreateRequestOptions.UNSET }})
    r"""Client-generated identifier, which can be used by lenders to track loan applications."""
    include_fast_report: Optional[bool] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('include_fast_report'), 'exclude': lambda f: f is AssetReportCreateRequestOptions.UNSET }})
    ...
    webhook: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('webhook'), 'exclude': lambda f: f is AssetReportCreateRequestOptions.UNSET }})
