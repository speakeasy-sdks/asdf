...
class WatchlistScreeningIndividualProgramGetResponse:
    ...
    lists_enabled: List[shared_individualwatchlistcode.IndividualWatchlistCode] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lists_enabled') }})
