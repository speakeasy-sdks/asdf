...
from ..shared import wallettransactioncounterpartynumbers as shared_wallettransactioncounterpartynumbers
...
class WalletTransactionCounterparty:
    ...
    numbers: shared_wallettransactioncounterpartynumbers.WalletTransactionCounterpartyNumbers = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('numbers') }})
