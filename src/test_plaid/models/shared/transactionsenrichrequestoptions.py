...
class TransactionsEnrichRequestOptions:
    ...
    include_legacy_category: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('include_legacy_category'), 'exclude': lambda f: f is None }})
