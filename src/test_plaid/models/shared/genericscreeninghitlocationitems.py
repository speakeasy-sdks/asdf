...
from ..shared import watchlistscreeninghitlocations as shared_watchlistscreeninghitlocations
...
class GenericScreeningHitLocationItems:
    r"""Analyzed location information for the associated hit"""
    ...
    data: Optional[shared_watchlistscreeninghitlocations.WatchlistScreeningHitLocations] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
