...
import dataclasses
from ..shared import partnerendcustomerwithsecrets as shared_partnerendcustomerwithsecrets
...
class PartnerCustomerCreateResponse:
    ...
    end_customer: Optional[shared_partnerendcustomerwithsecrets.PartnerEndCustomerWithSecrets] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('end_customer'), 'exclude': lambda f: f is None }})
