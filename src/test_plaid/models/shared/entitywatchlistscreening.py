...
import dataclasses
from ..shared import entitywatchlistscreeningsearchterms as shared_entitywatchlistscreeningsearchterms
...
class EntityWatchlistScreening:
    ...
    search_terms: shared_entitywatchlistscreeningsearchterms.EntityWatchlistScreeningSearchTerms = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('search_terms') }})
