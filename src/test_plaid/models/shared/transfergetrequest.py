...
class TransferGetRequest:
    r"""Defines the request schema for `/transfer/get`"""
    ...
    originator_client_id: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('originator_client_id'), 'exclude': lambda f: f is TransferGetRequest.UNSET }})
