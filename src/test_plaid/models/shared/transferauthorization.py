...
from ..shared import signalinsights as shared_signalinsights
from ..shared import transferauthorizationdecision as shared_transferauthorizationdecision
from ..shared import transferauthorizationdecisionrationale as shared_transferauthorizationdecisionrationale
...
from ..shared import transferauthorizationproposedtransfer as shared_transferauthorizationproposedtransfer
...
class TransferAuthorization:
    ...
    decision: shared_transferauthorizationdecision.TransferAuthorizationDecision = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('decision') }})
    ...
    """
    decision_rationale: Optional[shared_transferauthorizationdecisionrationale.TransferAuthorizationDecisionRationale] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('decision_rationale') }})
    ...
    proposed_transfer: shared_transferauthorizationproposedtransfer.TransferAuthorizationProposedTransfer = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('proposed_transfer') }})
    r"""Details regarding the proposed transfer."""
    additional_properties: Optional[Dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'exclude': lambda f: f is None }})
    signal_insights: Optional[shared_signalinsights.SignalInsights] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('signal_insights') }})
