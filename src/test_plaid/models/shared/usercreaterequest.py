...
class UserCreateRequest:
    ...
    consumer_report_user_identity: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('consumer_report_user_identity'), 'exclude': lambda f: f is None }})
