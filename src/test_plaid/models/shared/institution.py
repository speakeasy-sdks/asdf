...
import dataclasses
from ..shared import authmetadata as shared_authmetadata
from ..shared import countrycode as shared_countrycode
from ..shared import institutionstatus as shared_institutionstatus
from ..shared import paymentinitiationmetadata as shared_paymentinitiationmetadata
...
class Institution:
    ...
    auth_metadata: Optional[shared_authmetadata.AuthMetadata] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_metadata') }})
    ...
    payment_initiation_metadata: Optional[shared_paymentinitiationmetadata.PaymentInitiationMetadata] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payment_initiation_metadata') }})
    ...
    status: Optional[shared_institutionstatus.InstitutionStatus] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
