...
class WatchlistScreeningEntityUpdateRequest:
    ...
    reset_fields: Optional[list[shared_watchlistscreeningentityupdaterequestresettablefield.WatchlistScreeningEntityUpdateRequestResettableField]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reset_fields') }})
    r"""A list of fields to reset back to null"""
    search_terms: Optional[shared_updateentityscreeningrequestsearchterms.UpdateEntityScreeningRequestSearchTerms] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('search_terms') }})
