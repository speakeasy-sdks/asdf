...
import dataclasses
from ..shared import updateentityscreeningrequestsearchterms as shared_updateentityscreeningrequestsearchterms
from ..shared import watchlistscreeningentityupdaterequestresettablefield as shared_watchlistscreeningentityupdaterequestresettablefield
...
class WatchlistScreeningEntityUpdateRequest:
    ...
    reset_fields: Optional[list[shared_watchlistscreeningentityupdaterequestresettablefield.WatchlistScreeningEntityUpdateRequestResettableField]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reset_fields'), 'exclude': lambda f: f is None }})
    r"""A list of fields to reset back to null"""
    search_terms: Optional[shared_updateentityscreeningrequestsearchterms.UpdateEntityScreeningRequestSearchTerms] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('search_terms'), 'exclude': lambda f: f is None }})
