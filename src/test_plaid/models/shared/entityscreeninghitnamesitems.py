...
import dataclasses
from ..shared import entityscreeninghitnames as shared_entityscreeninghitnames
...
class EntityScreeningHitNamesItems:
    r"""Analyzed names for the associated hit"""
    ...
    data: Optional[shared_entityscreeninghitnames.EntityScreeningHitNames] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
