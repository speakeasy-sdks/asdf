...
class WatchlistScreeningEntityHitListRequest:
    r"""Request input for listing hits for an entity watchlist screening"""
    ...
    cursor: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cursor'), 'exclude': lambda f: f is WatchlistScreeningEntityHitListRequest.UNSET }})
