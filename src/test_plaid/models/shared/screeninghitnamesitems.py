...
import dataclasses
from ..shared import individualscreeninghitnames as shared_individualscreeninghitnames
...
class ScreeningHitNamesItems:
    ...
    data: Optional[shared_individualscreeninghitnames.IndividualScreeningHitNames] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
