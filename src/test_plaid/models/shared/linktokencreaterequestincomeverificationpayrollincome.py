...
class LinkTokenCreateRequestIncomeVerificationPayrollIncome:
    ...
    flow_types: Optional[List[shared_incomeverificationpayrollflowtype.IncomeVerificationPayrollFlowType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flow_types') }})
    ...
    parsing_config: Optional[List[shared_incomeverificationdocparsingconfig.IncomeVerificationDocParsingConfig]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('parsing_config') }})
