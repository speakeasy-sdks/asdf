...
import dataclasses
from ..shared import incomeverificationdocparsingconfig as shared_incomeverificationdocparsingconfig
from ..shared import incomeverificationpayrollflowtype as shared_incomeverificationpayrollflowtype
...
class LinkTokenCreateRequestIncomeVerificationPayrollIncome:
    ...
    flow_types: Optional[list[shared_incomeverificationpayrollflowtype.IncomeVerificationPayrollFlowType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flow_types'), 'exclude': lambda f: f is None }})
    ...
    item_id_to_update: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('item_id_to_update'), 'exclude': lambda f: f is None }})
    ...
    parsing_config: Optional[list[shared_incomeverificationdocparsingconfig.IncomeVerificationDocParsingConfig]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('parsing_config'), 'exclude': lambda f: f is None }})
