...
import dataclasses
from ..shared import idnumbertype as shared_idnumbertype
...
class BeaconUserIDNumber:
    ...
    type: shared_idnumbertype.IDNumberType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
