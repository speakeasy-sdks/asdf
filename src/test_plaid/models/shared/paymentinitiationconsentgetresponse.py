...
from ..shared import paymentinitiationconsentstatus as shared_paymentinitiationconsentstatus
...
class PaymentInitiationConsentGetResponse:
    r"""PaymentInitiationConsent defines a payment initiation consent."""
    ...
    status: shared_paymentinitiationconsentstatus.PaymentInitiationConsentStatus = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
