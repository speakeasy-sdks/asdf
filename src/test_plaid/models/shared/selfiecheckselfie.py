...
import dataclasses
from ..shared import selfieanalysis as shared_selfieanalysis
from ..shared import selfiecapture as shared_selfiecapture
from ..shared import selfiestatus as shared_selfiestatus
...
class SelfieCheckSelfie:
    ...
    analysis: shared_selfieanalysis.SelfieAnalysis = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('analysis') }})
    ...
    capture: shared_selfiecapture.SelfieCapture = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('capture') }})
    r"""The image or video capture of a selfie. Only one of image or video URL will be populated per selfie."""
    status: shared_selfiestatus.SelfieStatus = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
