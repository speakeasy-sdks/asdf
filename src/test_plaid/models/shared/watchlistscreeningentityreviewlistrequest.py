...
class WatchlistScreeningEntityReviewListRequest:
    r"""Request input for listing reviews for an entity watchlist screening"""
    ...
    cursor: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cursor'), 'exclude': lambda f: f is WatchlistScreeningEntityReviewListRequest.UNSET }})
