...
import dataclasses
from ..shared import distributionbreakdown as shared_distributionbreakdown
...
class PayPeriodDetails:
    ...
    distribution_breakdown: Optional[List[shared_distributionbreakdown.DistributionBreakdown]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('distribution_breakdown'), 'exclude': lambda f: f is None }})
    ...
    """
    pay_frequency: Optional[PayPeriodDetailsPayFrequency] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pay_frequency') }})
    r"""The frequency at which an individual is paid."""
