...
import dataclasses
from .crabankincomecause import CraBankIncomeCause
from .crabankincomewarningcode import CraBankIncomeWarningCode
...
class CraBankIncomeWarning:
    ...
    cause: Optional[CraBankIncomeCause] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cause'), 'exclude': lambda f: f is None }})
    ...
    warning_code: Optional[CraBankIncomeWarningCode] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('warning_code'), 'exclude': lambda f: f is None }})
