...
import dataclasses
from ..shared import earningsbreakdowncanonicaldescription as shared_earningsbreakdowncanonicaldescription
...
class EarningsBreakdown:
    ...
    canonical_description: Optional[shared_earningsbreakdowncanonicaldescription.EarningsBreakdownCanonicalDescription] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('canonical_description') }})
    ...
    rate: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rate') }})
