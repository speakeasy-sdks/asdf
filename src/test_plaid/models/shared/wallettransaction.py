...
class WalletTransaction:
    ...
    failure_reason: Optional[WalletTransactionFailureReason] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failure_reason'), 'exclude': lambda f: f is WalletTransaction.UNSET }})
    ...
    """
    payment_id: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payment_id'), 'exclude': lambda f: f is WalletTransaction.UNSET }})
    ...
    scheme: Optional[WalletPaymentScheme] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('scheme'), 'exclude': lambda f: f is WalletTransaction.UNSET }})
