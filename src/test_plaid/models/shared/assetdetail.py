...
class AssetDetail:
    ...
    asset_available_balance_amount: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AssetAvailableBalanceAmount') }})
    r"""Asset Account Available Balance."""
    asset_current_balance_amount: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AssetCurrentBalanceAmount') }})
