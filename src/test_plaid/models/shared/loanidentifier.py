...
import dataclasses
from ..shared import loanidentifiertype as shared_loanidentifiertype
...
class LoanIdentifier:
    ...
    loan_identifier_type: Optional[shared_loanidentifiertype.LoanIdentifierType] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('LoanIdentifierType') }})
