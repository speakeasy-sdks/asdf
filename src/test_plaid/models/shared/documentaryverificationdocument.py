...
from ..shared import documentanalysis as shared_documentanalysis
from ..shared import documentstatus as shared_documentstatus
from ..shared import physicaldocumentextracteddata as shared_physicaldocumentextracteddata
from ..shared import physicaldocumentimages as shared_physicaldocumentimages
...
class DocumentaryVerificationDocument:
    ...
    analysis: shared_documentanalysis.DocumentAnalysis = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('analysis') }})
    ...
    extracted_data: Optional[shared_physicaldocumentextracteddata.PhysicalDocumentExtractedData] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('extracted_data') }})
    r"""Data extracted from a user-submitted document."""
    images: shared_physicaldocumentimages.PhysicalDocumentImages = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('images') }})
    ...
    status: shared_documentstatus.DocumentStatus = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
