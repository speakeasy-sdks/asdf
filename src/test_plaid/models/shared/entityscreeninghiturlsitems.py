...
import dataclasses
from ..shared import entityscreeninghiturls as shared_entityscreeninghiturls
...
class EntityScreeningHitUrlsItems:
    ...
    data: Optional[shared_entityscreeninghiturls.EntityScreeningHitUrls] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
