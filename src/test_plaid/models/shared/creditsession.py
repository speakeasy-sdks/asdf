...
from ..shared import creditsessionerror as shared_creditsessionerror
from ..shared import creditsessionresults as shared_creditsessionresults
...
class CreditSession:
    ...
    errors: Optional[List[shared_creditsessionerror.CreditSessionError]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errors'), 'exclude': lambda f: f is None }})
    ...
    results: Optional[shared_creditsessionresults.CreditSessionResults] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})
