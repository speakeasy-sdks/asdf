...
import dataclasses
from ..shared import clientprovidedtransaction as shared_clientprovidedtransaction
...
class TransactionsEnrichGetRequest:
    ...
    transactions: List[shared_clientprovidedtransaction.ClientProvidedTransaction] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transactions') }})
