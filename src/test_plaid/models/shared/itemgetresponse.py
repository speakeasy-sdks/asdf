...
from ..shared import itemstatusnullable as shared_itemstatusnullable
...
class ItemGetResponse:
    ...
    status: Optional[shared_itemstatusnullable.ItemStatusNullable] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
