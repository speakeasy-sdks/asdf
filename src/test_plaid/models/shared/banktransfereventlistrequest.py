...
class BankTransferEventListRequest:
    ...
    bank_transfer_type: Optional[shared_banktransfereventlistbanktransfertype.BankTransferEventListBankTransferType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bank_transfer_type'), 'exclude': lambda f: f is None }})
    ...
    direction: Optional[shared_banktransfereventlistdirection.BankTransferEventListDirection] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('direction'), 'exclude': lambda f: f is None }})
