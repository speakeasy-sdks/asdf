...
class ConnectedApplication:
    ...
    application_url: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('application_url'), 'exclude': lambda f: f is ConnectedApplication.UNSET }})
    r"""The URL for the application's website"""
    display_name: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('display_name'), 'exclude': lambda f: f is ConnectedApplication.UNSET }})
    r"""A human-readable name of the application for display purposes"""
    logo_url: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logo_url'), 'exclude': lambda f: f is ConnectedApplication.UNSET }})
    r"""A URL that links to the application logo image."""
    reason_for_access: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason_for_access'), 'exclude': lambda f: f is ConnectedApplication.UNSET }})
    r"""A string provided by the connected app stating why they use their respective enabled products."""
    scopes: Optional[ScopesNullable] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('scopes'), 'exclude': lambda f: f is ConnectedApplication.UNSET }})
    r"""The scopes object"""
