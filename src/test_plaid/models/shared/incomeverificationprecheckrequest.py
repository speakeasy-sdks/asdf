...
class IncomeVerificationPrecheckRequest:
    ...
    employer: Optional[shared_incomeverificationprecheckemployer.IncomeVerificationPrecheckEmployer] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('employer') }})
    r"""Information about the end user's employer"""
    payroll_institution: Optional[shared_incomeverificationprecheckpayrollinstitution.IncomeVerificationPrecheckPayrollInstitution] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payroll_institution') }})
    ...
    us_military_info: Optional[shared_incomeverificationprecheckmilitaryinfo.IncomeVerificationPrecheckMilitaryInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('us_military_info') }})
    r"""Data about military info in the income verification precheck."""
    user: Optional[shared_incomeverificationprecheckuser.IncomeVerificationPrecheckUser] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('user') }})
