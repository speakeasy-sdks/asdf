...
class PlaidError:
    ...
    status: Optional[int] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is PlaidError.UNSET }})
    ...
    suggested_action: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('suggested_action'), 'exclude': lambda f: f is PlaidError.UNSET }})
