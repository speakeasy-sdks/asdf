...
from ..shared import sandboxpublictokencreaterequestincomeverificationbankincome as shared_sandboxpublictokencreaterequestincomeverificationbankincome
...
class SandboxPublicTokenCreateRequestOptionsIncomeVerification:
    ...
    bank_income: Optional[shared_sandboxpublictokencreaterequestincomeverificationbankincome.SandboxPublicTokenCreateRequestIncomeVerificationBankIncome] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bank_income'), 'exclude': lambda f: f is None }})
