...
import dataclasses
from ..shared import documentaryverificationdocument as shared_documentaryverificationdocument
...
class DocumentaryVerification:
    ...
    documents: List[shared_documentaryverificationdocument.DocumentaryVerificationDocument] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('documents') }})
