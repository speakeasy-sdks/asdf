...
import dataclasses
from ..shared import individualname as shared_individualname
...
class PartyIndividual:
    ...
    name: shared_individualname.IndividualName = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('NAME') }})
