...
class UpdateIndividualScreeningRequestSearchTerms:
    ...
    watchlist_program_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('watchlist_program_id'), 'exclude': lambda f: f is None }})
