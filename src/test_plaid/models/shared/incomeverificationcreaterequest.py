...
import dataclasses
from ..shared import incomeverificationcreaterequestoptions as shared_incomeverificationcreaterequestoptions
...
class IncomeVerificationCreateRequest:
    ...
    options: Optional[shared_incomeverificationcreaterequestoptions.IncomeVerificationCreateRequestOptions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('options'), 'exclude': lambda f: f is None }})
