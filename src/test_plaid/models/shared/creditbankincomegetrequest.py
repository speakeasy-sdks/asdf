...
import dataclasses
from ..shared import creditbankincomegetrequestoptions as shared_creditbankincomegetrequestoptions
...
class CreditBankIncomeGetRequest:
    ...
    options: Optional[shared_creditbankincomegetrequestoptions.CreditBankIncomeGetRequestOptions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('options'), 'exclude': lambda f: f is None }})
