...
class SandboxBankTransferSimulateRequest:
    ...
    failure_reason: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failure_reason'), 'exclude': lambda f: f is None }})
