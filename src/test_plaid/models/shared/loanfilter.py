...
import dataclasses
from ..shared import loanaccountsubtype as shared_loanaccountsubtype
...
class LoanFilter:
    ...
    account_subtypes: List[shared_loanaccountsubtype.LoanAccountSubtype] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('account_subtypes') }})
