...
from ..shared import entityscreeninghitanalysis as shared_entityscreeninghitanalysis
from ..shared import entityscreeninghitdata as shared_entityscreeninghitdata
...
class EntityWatchlistScreeningHit:
    ...
    r"""An ISO8601 formatted timestamp."""
    list_code: shared_entitywatchlistcode.EntityWatchlistCode = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list_code') }})
    ...
    analysis: Optional[shared_entityscreeninghitanalysis.EntityScreeningHitAnalysis] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('analysis'), 'exclude': lambda f: f is None }})
    r"""Analysis information describing why a screening hit matched the provided entity information"""
    data: Optional[shared_entityscreeninghitdata.EntityScreeningHitData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
