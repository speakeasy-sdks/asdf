...
class LinkTokenCreateRequestAuth:
    ...
    auth_type_select_enabled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type_select_enabled'), 'exclude': lambda f: f is None }})
