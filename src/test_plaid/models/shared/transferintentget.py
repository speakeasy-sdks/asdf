...
from ..shared import transferintentauthorizationdecision as shared_transferintentauthorizationdecision
...
from ..shared import transferintentgetfailurereason as shared_transferintentgetfailurereason
...
class TransferIntentGet:
    ...
    authorization_decision: Optional[shared_transferintentauthorizationdecision.TransferIntentAuthorizationDecision] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authorization_decision') }})
    ...
    """
    authorization_decision_rationale: Optional[shared_transferauthorizationdecisionrationale.TransferAuthorizationDecisionRationale] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authorization_decision_rationale') }})
    ...
    failure_reason: Optional[shared_transferintentgetfailurereason.TransferIntentGetFailureReason] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failure_reason') }})
