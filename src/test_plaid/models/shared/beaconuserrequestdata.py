...
from ..shared import beaconuserrequestaddress as shared_beaconuserrequestaddress
...
class BeaconUserRequestData:
    ...
    address: shared_beaconuserrequestaddress.BeaconUserRequestAddress = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address') }})
    ...
    id_number: Optional[shared_beaconuseridnumber.BeaconUserIDNumber] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id_number'), 'exclude': lambda f: f is None }})
