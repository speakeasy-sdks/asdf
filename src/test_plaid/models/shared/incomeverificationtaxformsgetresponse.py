...
from ..shared import taxform as shared_taxform
...
class IncomeVerificationTaxformsGetResponse:
    ...
    document_metadata: List[shared_documentmetadata.DocumentMetadata] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('document_metadata') }})
    taxforms: List[shared_taxform.Taxform] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxforms') }})
    r"""A list of forms."""
