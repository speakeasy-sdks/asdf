...
import dataclasses
from ..shared import assetreportfreddie as shared_assetreportfreddie
...
class AssetReportFreddieGetResponse:
    ...
    deal: shared_assetreportfreddie.AssetReportFreddie = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DEAL') }})
