...
from .creditfreddiemacverificationofassetresponse_voe_2_5 import CreditFreddieMacVerificationOfAssetResponseVOE25
...
class CreditFreddieMacVerificationOfAssetVOE25:
    ...
    verification_of_asset_response: CreditFreddieMacVerificationOfAssetResponseVOE25 = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('VERIFICATION_OF_ASSET_RESPONSE') }})
    r"""Documentation not found in the MISMO model viewer and not provided by Freddie Mac."""
