...
from ..shared import paystubtaxpayerid as shared_paystubtaxpayerid
...
class CreditPayStubEmployee:
    ...
    address: shared_creditpaystubaddress.CreditPayStubAddress = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address') }})
    ...
    taxpayer_id: shared_paystubtaxpayerid.PayStubTaxpayerID = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxpayer_id') }})
