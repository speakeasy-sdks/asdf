...
class TransferAuthorizationCreateRequest:
    ...
    user: shared_transferauthorizationuserinrequest.TransferAuthorizationUserInRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('user') }})
    ...
    """
    beacon_session_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('beacon_session_id'), 'exclude': lambda f: f is None }})
    ...
    credit_funds_source: Optional[shared_transfercreditfundssource.TransferCreditFundsSource] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credit_funds_source'), 'exclude': lambda f: f is None }})
    ...
    funding_account_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('funding_account_id'), 'exclude': lambda f: f is None }})
    ...
    """
    originator_client_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('originator_client_id'), 'exclude': lambda f: f is None }})
    ...
    with_guarantee: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('with_guarantee'), 'exclude': lambda f: f is None }})
