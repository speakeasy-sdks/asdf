...
class TransferAuthorizationCreateRequest:
    ...
    credit_funds_source: Optional[shared_transfercreditfundssource.TransferCreditFundsSource] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credit_funds_source') }})
